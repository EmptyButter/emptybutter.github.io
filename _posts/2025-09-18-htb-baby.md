...
4. Spray the default password using `kerbrute` and found a match.
...
The user was a member of the `Remote Management Users` group, indicating it may be able to log in via WinRM.
...
I used it to performed a DCSync attack and dumped the NTDS database.
```
